...
if(isset($_POST['update_user'])) {
    ...
    $user_password = test_form_input($_POST['user_password']);
    ...
    $sql = "UPDATE users SET user_firstname='$user_firstname',user_lastname='$user_lastname',user_email='$user_email',user_address='$user_address',user_phone='$user_phone',user_role='$user_role',user_image= '$user_image' WHERE user_id='{$_POST['user_id']}'";
    ...
    $sql = "UPDATE login SET username='$user_username', password='$user_password' WHERE user_id='{$_POST['user_id']}'";

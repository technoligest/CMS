<form id="signup_form" class="form-horizontal" action="includes/form_submission/signup.php" method="post"
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <div class="col-md-2 col-md-offset-5 col-sm-2 col-sm-offset-5">
                        <button type="submit" name="signup_btn" class="btn btn-success">Signup <span

...
<div class="col-md-8 col-sm-12">
    <form id="login_form" class="form-horizontal" action="includes/form_submission/signup.php" method="post" enctype="multipart/form-data" data-toggle="validator">
        <fieldset>
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="col-md-2 col-md-offset-5 col-sm-2 col-sm-offset-5">
                            <button type="submit" name="post_ad_btn" class="btn btn-success">Signup <span class="glyphicon glyphicon-send"></span></button>
                        </div>
                    </div>
                </div>
